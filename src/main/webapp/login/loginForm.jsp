...
// return true; 기본값이 true라 없어도 됨
}
// 자바스크립트 form 태크의 데이터 전송을 막는 방법으로 onsubmit이벤트를 활용
// return false 이면 action이 진행하지 않음
// 기본값은 return true임
function gojoinFrom() {
...
<div id="wrap">
	...
	onsubmit="return checkValue();"><!-- script에 return이 false이면 화면이 안넘어감  -->
